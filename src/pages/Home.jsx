    ...
    return (
        <div className="font-sans text-black relative">
            ...
            <header className="bg-gradient-to-r from-blue-700 to-blue-600 text-white shadow-md">
                <div className="flex flex-col md:flex-row items-center justify-between py-10 px-10 md:px-2 max-w-6xl mx-auto">
                    {/* Logo + Title */}
                    <div className="flex items-center space-x-2">
                        <div>
                            <img src="/favicon-2.png" alt="Matterhorn Logo" className="w-12 h-12" />
                    ...
                    <div className="flex items-center space-x-4 mt-4 md:mt-0 text-lg">
                        <FaFacebookF className="hover:text-blue-200 hover:scale-110 transition-all duration-300 cursor-pointer" />
                        <FaLinkedinIn className="hover:text-blue-200 hover:scale-110 transition-all duration-300 cursor-pointer" />
                        <FaXTwitter className="hover:text-blue-200 hover:scale-110 transition-all duration-300 cursor-pointer" />
                        <FaYoutube className="hover:text-blue-200 hover:scale-110 transition-all duration-300 cursor-pointer" />
                    </div>
                </div>
            </header>
            ...
            {/* Hero Section */}
            <section className="relative flex flex-col items-center justify-center px-4 md:px-8 pt-24 pb-12 max-w-7xl mx-auto text-center min-h-screen overflow-hidden">
