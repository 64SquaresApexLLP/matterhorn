...
function HomePage() {
    ...
    return (
        <div className="font-sans text-black relative">
            ...
            {/* Hero Section */}
            <section className="relative flex flex-col items-center justify-center px-4 md:px-8 pt-24 pb-12 max-w-7xl mx-auto text-center min-h-[60vh] overflow-hidden">
