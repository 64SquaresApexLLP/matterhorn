            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <SortableHeader field="matterNumber" className="min-w-[120px]">
                      Matter Number
                    </SortableHeader>
                    <SortableHeader field="client" className="min-w-[200px] hidden sm:table-cell">
                      Client
                    </SortableHeader>
                    <SortableHeader field="date" className="min-w-[100px]">
                      Date
                    </SortableHeader>
                    <SortableHeader field="timekeeper" className="min-w-[150px] hidden md:table-cell">
                      Timekeeper
                    </SortableHeader>
                    <SortableHeader field="type" className="min-w-[80px]">
                      Type
                    </SortableHeader>
                    <SortableHeader field="status" className="min-w-[100px]">
                      Status
                    </SortableHeader>
                    <SortableHeader field="total" className="min-w-[120px]">
                      Total
                    </SortableHeader>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {paginatedData.map((entry, index) => (
                    ...
                    >
                      ...
                      <td className="px-3 sm:px-6 py-4 text-sm text-gray-500 max-w-[200px] hidden sm:table-cell">
